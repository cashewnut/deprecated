...
public class Exp4 {
    ...
    public void accept(String baseUri, String content) throws IOException, ResourceResolverException {
        ...
        String encode = URLEncoder.encode(baseUri, new String("a"));
        ...
        ResourceResolverContext resourceResolverContext = new ResourceResolverContext(attr,encode,Boolean.TRUE);
